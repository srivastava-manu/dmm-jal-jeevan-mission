...
const STATE_ROWS = [
  ["Andhra Pradesh", "K. Raghavendra", "Joint Director (IT)", "raghavendra@apswsm.gov.in", "12 Jul 2026", 86],
  ["Assam", "P. Deka", "State IT Officer", "p.deka@assamjjm.gov.in", "04 Jul 2026", 53],
  ["Bihar", "S. Kumar", "OSD (Digital)", "s.kumar@phedbihar.gov.in", "28 Jun 2026", 46],
  ["Chhattisgarh", "M. Sahu", "Deputy Director (MIS)", "m.sahu@cgphed.gov.in", "09 Jul 2026", 62],
  ["Gujarat", "H. Patel", "State IT Officer", "h.patel@wasmo.org", "02 Jul 2026", 102],
  ["Haryana", "R. Yadav", "Nodal Officer (IT)", "r.yadav@phedharyana.gov.in", "15 Jul 2026", 71],
  ["Himachal Pradesh", "A. Thakur", "State IT Officer", "a.thakur@hpjjm.gov.in", "21 Jun 2026", 55],
  ["Jharkhand", "N. Oraon", "Deputy Director (IT)", "n.oraon@dwsdjharkhand.gov.in", "18 Jul 2026", 42],
  ["Karnataka", "R. Meenakshi", "State IT Officer", "meenakshi@rdpr.kar.gov.in", "04 Aug 2026", 68],
  ["Kerala", "V. Nair", "Systems Manager", "v.nair@kwa.kerala.gov.in", "11 Jul 2026", 99],
  ["Madhya Pradesh", "D. Verma", "State IT Officer", "d.verma@mpphed.gov.in", "07 Jul 2026", 65],
  ["Maharashtra", "S. Kulkarni", "Joint Director (IT)", "s.kulkarni@mahajjm.gov.in", "01 Jul 2026", 88],
  ["Odisha", "B. Mohanty", "State IT Officer", "b.mohanty@rwssodisha.gov.in", "25 Jun 2026", 62],
  ["Punjab", "G. Singh", "Nodal Officer (MIS)", "g.singh@pbdwss.gov.in", "14 Jul 2026", 78],
  ["Rajasthan", "L. Meena", "Additional Director (IT)", "l.meena@phedrajasthan.gov.in", "30 Jun 2026", 51],
  ["Tamil Nadu", "T. Selvam", "State IT Officer", "t.selvam@twadboard.gov.in", "08 Jul 2026", 107],
  ["Telangana", "K. Reddy", "Deputy Director (IT)", "k.reddy@tsjjm.gov.in", "16 Jul 2026", 82],
  ["Uttar Pradesh", "A. Srivastava", "State IT Officer", "a.srivastava@upjjm.gov.in", "10 Jul 2026", 51],
  ["Uttarakhand", "P. Bisht", "Nodal Officer (IT)", "p.bisht@ukjalnigam.gov.in", "22 Jun 2026", 43],
  ["West Bengal", "S. Ghosh", "State IT Officer", "s.ghosh@wbphed.gov.in", "05 Jul 2026", 67],
...
// Index follows the current model's flattened layer/capability order.
const BASELINE = [
  // Citizens
  ...
  // Department
  2.7, 3.0, 1.6, 2.4, 2.2, 1.8, 2.4, 1.5,
...
function scoresFor(seedTotal, key) {
  ...
  const strength = (seedTotal - baseTotal) / 36;
...
const REQUESTS = [
  ...
  { id: "rq4", state: "Uttarakhand", capability: "Digital Platform & Architecture", layer: "Technology Foundation", score: 1,
    date: "23 Jun 2026", status: "Closed", note: "The state needs guidance on a scalable and resilient architecture for digital services.", reply: "Reference architecture and implementation guidance shared on 27 Jun." },
